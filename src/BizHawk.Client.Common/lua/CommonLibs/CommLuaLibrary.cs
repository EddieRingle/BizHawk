...
namespace BizHawk.Client.Common
{
	...
	public sealed class CommLuaLibrary : LuaLibraryBase
	{
		...
		public int MmfOpenOrCreateFile(string filePath, long capacity)
		{
